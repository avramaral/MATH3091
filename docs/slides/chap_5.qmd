...
\end{align*}
i.e., the canonical link function for this example is $g(\mu) = \text{logit}(\mu)$. This follows since $\theta = b^{'-1}(\mu)$ and, for the canonical link function, $g(\mu)\equiv b^{'-1}(\mu)$. 

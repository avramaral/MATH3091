...
Welcome to the second part of **[MATH3091: Statistical Modelling]{.attention}**. The first part of the module was taught by Dr Helen Ogden, covering Chapters 1–4 from the lecture notes (see below). This part will focus on **Generalised Linear Models (Chapter 5)** and **Models for Categorical Data (Chapter 6)**.
